...
@Component({
  selector: 'app-banner-pricing',
  templateUrl: './banner-pricing.component.html',
  styleUrls: ['./banner-pricing.component.scss']
})
export class BannerPricingComponent implements OnInit {
